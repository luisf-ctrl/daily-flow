...
import type { GermanState } from "@/integrations/supabase/types";
        ...
        <CardContent className="pt-6">
          <div className="space-y-3">
            ...
            <p className="text-[11px] text-muted-foreground pt-2">
              Annahme Kaufpreis {eur.format(price)} · Werte gerundet · tatsächliche
              Notar-Gebühren variieren nach GNotKG-Tabelle.
            </p>
          </div>
        </CardContent>
      </Card>
