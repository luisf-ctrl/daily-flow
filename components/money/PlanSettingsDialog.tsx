...
import { upsertHousePurchasePlan } from "@/app/(app)/money/actions";
...
export function PlanSettingsDialog({
  ...
  function onSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    startTransition(async () => {
      try {
        await upsertHousePurchasePlan(fd);
        ...
        <form onSubmit={onSubmit} className="space-y-6">
          ...
          <fieldset className="space-y-4">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              ...
              <div className="space-y-2">
                <Label htmlFor="income-business">Einzelunternehmen (Gewinn vor Steuern)</Label>
                <Input
                  id="income-business"
          ...
          <Button type="submit" disabled={pending} className="w-full">
            {pending ? "Speichere..." : plan ? "Plan aktualisieren" : "Plan erstellen"}
          </Button>
        </form>
      </DialogContent>
    </Dialog>
