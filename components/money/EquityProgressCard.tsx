...
import type { FinancingScenario, SavingsPlan } from "@/lib/finance/calc";
import type { HousePurchasePlan } from "@/lib/types";
          ...
          <div className="flex items-start gap-3 rounded-lg border border-danger/30 bg-danger/10 p-4">
            ...
            <div className="text-sm">
              ...
              <p className="text-muted-foreground mt-1">
                ...
                sparen, hast aber nur {eur.format(savingsPlan.cashflowAvailable)}{" "}
                übrig. Optionen:
